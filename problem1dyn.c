...
int main(int argc, char** argv) {
    ...
    int* data = (int*)malloc(sizeof(int) * WIDTH * (end_row - start_row));
    ...
    MPI_Gather(data, WIDTH * (end_row - start_row), MPI_INT, Data, WIDTH * (end_row - start_row), MPI_INT, 0, MPI_COMM_WORLD);
